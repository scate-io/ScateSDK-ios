...
Set the **Dependency Rule** to **Up to Next Major Version** from `7.0.21`, then add the **ScateSDK** library product to your app target.

Or add it to your `Package.swift`:

```swift
dependencies: [
    .package(url: "https://github.com/scate-io/ScateSDK-ios", from: "7.0.21")
]
```
